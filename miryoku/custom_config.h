...
#define MIRYOKU_LAYER_BASE \
                ...
                U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, TAB),U_LT(U_NUM, BSPC),U_LT(U_SYM, RET),  U_LT(U_MOUSE, SPACE), U_LT(U_FUN, DEL),  &kp GRAVE,         &kp SQT
...
#define MIRYOKU_LAYER_NAV \
                ...
                U_NP,              U_NP,              U_NP,              U_NP,              U_NP,              U_NP,              &kp BSPC,          &kp RET,           &kp DEL,           U_NP
